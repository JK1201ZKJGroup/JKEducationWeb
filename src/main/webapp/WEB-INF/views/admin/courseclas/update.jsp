				...
				<sf:form method="post" modelAttribute="courseclas" class="am-form"
					...
					<div class="am-tabs-bd">
						<div class="am-tab-panel am-fade">
							...
							<%
							String classificationname =new String (request.getParameter("classificationname").getBytes("ISO-8859-1"));
// 							out.print(classificationname);
							%>					
							<div class="am-g am-margin-top">
								<div class="am-u-sm-4 am-u-md-2 am-text-right">分类名称:</div>
								<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
									<input type="text" class="am-input-sm" name="classificationname" value=<%=classificationname %> />
								</div>
							</div>						
							<div class="am-g am-margin-top">
